...
INSTALLED_APPS = [
    ...
    # تطبيقات منظومة المؤسسة الرقمية
    'hr',
    'management',
    'finance',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'management.permissions.permissions_context',
            ],
        },
    },
]
...
# المجلد الذي تضع فيه ملفاتك (CSS, JS, Images) أثناء العمل
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),
]

# المجلد الذي يجمع فيه Django الملفات عند تنفيذ collectstatic
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# --- إعدادات ملفات الميديا (الصور المرفوعة والأرشيف) ---
MEDIA_URL = '/media/'
